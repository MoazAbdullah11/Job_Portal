...
<head>
    ...
    <link rel="stylesheet" href="a{{asset('ssets/vendors/font-awesome/css/font-awesome.min.css')}}">
    <!-- endinject -->
            ...
            <div class="content-wrapper">
                ...
                <div class="div_center">
                    ...
                    <form action="{{ url('/add_catagory') }}" method="POST">
                        ...
                        <input type="submit" class="btn btn_primary" name="submit" value="Add Catagory">
                    </form>
